...
<html lang="en">
  <head>
    ...
    <title>PSC | Management of Education</title>
    @include('dist.css')
  </head>
        ...
        <div id="content">
          ...
          <div class="container-fluid" id="container-wrapper">
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
              <h1 class="h3 mb-0 text-gray-800">Management of Education</h1>
              <ol class="breadcrumb">
                <li class="breadcrumb-item" aria-current="page"><a href="Dashboard">Patient Safety Culture</a></li>
                <li class="breadcrumb-item active" aria-current="page">Management of Education</li>
              </ol>
            </div>
            <!-- Content Body -->
